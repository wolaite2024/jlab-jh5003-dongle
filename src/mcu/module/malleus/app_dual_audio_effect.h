...
#define dual_audio_mode_sel \
    app_audio_get_gaming_mode() ? app_cfg_nv.audio_effect_gaming_type : app_cfg_nv.audio_effect_normal_type

#define SITRONIX_KEY_UUID_ADDR         (0x02001100)
#define SITRONIX_KEY_EFUSE_INFO_ADDR   (0xAE)

#define SITRONIX_KEY_UUID_MAGIC        (0x5AA5)

#define SITRONIX_KEY_BT_MAC_LEN        (6)
#define SITRONIX_KEY_UUID_BASE_LEN     (14)
#define SITRONIX_KEY_UUID_MAGIC_LEN    (2)
#define SITRONIX_KEY_UUID_LEN          (SITRONIX_KEY_UUID_BASE_LEN+SITRONIX_KEY_UUID_MAGIC_LEN)

#define SITRONIX_KEY_LICENSE_LEN       (128)

#define SITRONIX_KEY_EFUSE_INFO_LEN    (2)
#define SITRONIX_KEY_TOTAL_LEN         (SITRONIX_KEY_BT_MAC_LEN+SITRONIX_KEY_UUID_LEN+SITRONIX_KEY_LICENSE_LEN+SITRONIX_KEY_EFUSE_INFO_LEN)
 ...
 * @return void
*/
void app_dual_audio_lr_info(T_DUAL_EFFECT_MODE_INFO parameter, uint8_t para_chanel_out);
 ...
 * @return void
*/
void app_dual_audio_set_bypass(bool enable);
...
*/
uint16_t app_dual_audio_get_effect_num(void);
