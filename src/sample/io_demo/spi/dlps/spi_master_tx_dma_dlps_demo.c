...
**********************************************************************************************************
* @file     spi_master_tx_dma_dlps_demo.c
* @brief    This file provides demo code of SPI master send data by dma mode in DLPS situation.
* @details
* @author
* @date     2024-3-13
* @version  v1.0
...
static void spi_master_init(void)
{
    ...
    RamVectorTableUpdate(SPI0_VECTORn, (IRQ_Fun)spi_tx_handler);
...
static void spi_dma_tx_data(uint8_t *pbuf, uint16_t len)
{
...
void spi_master_tx_dma_dlps_demo(void)
{
    test_timer_init();
...
static void timer_callback(void *xTimer)
{
    ...
    spi_dma_tx_data(SPI_TX_Buf, SPI_DATA_LEN);
