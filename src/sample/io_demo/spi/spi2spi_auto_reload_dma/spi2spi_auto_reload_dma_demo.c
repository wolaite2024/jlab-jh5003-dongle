...
**********************************************************************************************************
* @file     spi_dma_demo.c
* @brief    This file provides demo code of SPI0 read data from W25Q64 flash and SPI1 send data by Auto-Reload GDMA.
* @details
* @author   renee
* @date     2017-08-19
* @version  v1.0
 ...
 *                              Variables
 *============================================================================*/
static uint8_t spi_auto_reload_dma_ch_num = 0xa5;

#define SPI_AUTO_RELOAD_DMA_CHANNEL_NUM     spi_auto_reload_dma_ch_num
#define SPI_AUTO_RELOAD_DMA_CHANNEL         DMA_CH_BASE(spi_auto_reload_dma_ch_num)
#define SPI_AUTO_RELOAD_DMA_IRQ             DMA_CH_IRQ(spi_auto_reload_dma_ch_num)

/*============================================================================*
 *                              Functions
 *============================================================================*/
static void spi_auto_reload_dma_handler(void);
/**
...
static void driver_gdma_init(void)
{
    ...
    if (!GDMA_channel_request(&spi_auto_reload_dma_ch_num, spi_auto_reload_dma_handler, true))
    {
        return;
    }

    /*---------------------GDMA init----------------------------------*/
    GDMA_InitStruct.GDMA_ChannelNum          = SPI_AUTO_RELOAD_DMA_CHANNEL_NUM;
    ...
    GDMA_InitStruct.GDMA_Multi_Block_Mode    = AUTO_RELOAD_TRANSFER;

    GDMA_Init(SPI_AUTO_RELOAD_DMA_CHANNEL, &GDMA_InitStruct);
}
...
/**
  ...
  * @return  void
  */
void spi2spi_auto_reload_dma_demo(void)
{
    board_spi_init();
