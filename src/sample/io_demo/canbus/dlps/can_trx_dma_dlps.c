...
static void tx_gdma_driver_init()
{
    ...
    GDMA_InitStruct.GDMA_DestinationAddr     = (uint32_t)(uint32_t)CAN0->CAN_RAM_DATA15_0;
...
void can_trx_dma_dlps_demo(void)
{
    IO_PRINT_INFO0("can_trx_dma_dlps_demo: start");
