...
static uint8_t i2s_rx_dma_ch_num = 0xa5;
static int32_t i2s_send_buff[I2S_DMA_BUF_LEN];
static int32_t i2s_recv_buff[I2S_DMA_BUF_LEN];
...
/**
  ...
  * @return Void
  */
static void i2s_rx_dma_handler(void)
{
    /* do something */
...
/**
  ...
  * @return Void
  */
static void driver_gdma_init(T_I2S_CONFIG_DIR dir)
{
    ...
    else if (dir == I2S_CONFIG_RX)
    {
        ...
        {
            IO_PRINT_ERROR0("driver_gdma_init: i2s rx dma request fail");
...
/**
  ...
  * @return Void
  */
static void i2s_dma_operation(void)
{
...
/**
  ...
  * @return Void
*/
void i2s_master_dma_operation_demo(void)
{
    board_i2s_init();
    driver_i2s_init();
