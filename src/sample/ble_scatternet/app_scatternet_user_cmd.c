...
*****************************************************************************************
   * @file      app_scatternet_user_cmd.c
...
#define APP_STOP_CAUSE_USER_STOP 0xA0
/*============================================================================*
 *                              Functions
 *============================================================================*/
/**
...
static T_USER_CMD_PARSE_RESULT cmd_scan(T_USER_CMD_PARSED_VALUE *p_parse_value)
{
    ...
    app_scan_start(scan_filter_policy, scan_filter_duplicate);
    return (T_USER_CMD_PARSE_RESULT)cause;
}
...
{
    T_GAP_CAUSE cause = GAP_CAUSE_SUCCESS;
    app_adv_stop(APP_STOP_CAUSE_USER_STOP);
    return (T_USER_CMD_PARSE_RESULT)cause;
}
/**
...
static T_USER_CMD_PARSE_RESULT cmd_adv(T_USER_CMD_PARSED_VALUE *p_parse_value)
{
    ...
    T_GAP_ADV_FILTER_POLICY adv_filter_policy = GAP_ADV_FILTER_ANY;
    T_LE_EXT_ADV_LEGACY_ADV_PROPERTY adv_event_prop = LE_EXT_ADV_LEGACY_ADV_CONN_SCAN_UNDIRECTED;

    if (p_parse_value->param_count > 0)
    {
        adv_interval = p_parse_value->dw_param[0];
    }
    if (p_parse_value->param_count > 1)
    {
        adv_filter_policy = (T_GAP_ADV_FILTER_POLICY)p_parse_value->dw_param[1];
    }

    ble_ext_adv_mgr_change_adv_event_prop(adv_handle, adv_event_prop);
    ble_ext_adv_mgr_change_adv_interval(adv_handle, adv_interval);
    ble_ext_adv_mgr_change_filter_policy(adv_handle, adv_filter_policy);
    app_adv_start(0);

    return (T_USER_CMD_PARSE_RESULT)GAP_CAUSE_SUCCESS;
}
/**
...
static T_USER_CMD_PARSE_RESULT cmd_advld(T_USER_CMD_PARSED_VALUE *p_parse_value)
{
    ...
    T_GAP_REMOTE_ADDR_TYPE  adv_direct_type = GAP_REMOTE_ADDR_LE_PUBLIC;
    ...
    ble_ext_adv_mgr_change_filter_policy(adv_handle, adv_filter_policy);
    ble_ext_adv_mgr_change_adv_interval(adv_handle, adv_interval);
    ble_ext_adv_mgr_change_peer_addr(adv_handle, adv_direct_type, adv_direct_addr);
    app_adv_start(0);
...
static T_USER_CMD_PARSE_RESULT cmd_advhd(T_USER_CMD_PARSED_VALUE *p_parse_value)
{
    ...
    uint16_t adv_interval = 80;
    T_GAP_ADV_FILTER_POLICY adv_filter_policy = GAP_ADV_FILTER_ANY;
    T_LE_EXT_ADV_LEGACY_ADV_PROPERTY adv_event_prop = LE_EXT_ADV_LEGACY_ADV_CONN_HIGH_DUTY_DIRECTED;
...
static T_USER_CMD_PARSE_RESULT cmd_advscan(T_USER_CMD_PARSED_VALUE *p_parse_value)
{
    ...
    ble_ext_adv_mgr_change_filter_policy(adv_handle, adv_filter_policy);
    ble_ext_adv_mgr_change_adv_interval(adv_handle, adv_interval);
    ble_ext_adv_mgr_change_peer_addr(adv_handle, peer_address_type, peer_address);
    app_adv_start(0);
...
static T_USER_CMD_PARSE_RESULT cmd_simpv3notify(T_USER_CMD_PARSED_VALUE *p_parse_value)
{
    ...
    if (simp_ble_service_send_v3_notify(conn_handle, L2C_FIXED_CID_ATT, simp_srv_id,
                                        &notif_val, length))
    {
        return (RESULT_SUCESS);
    }
...
static T_USER_CMD_PARSE_RESULT cmd_simpv4ind(T_USER_CMD_PARSED_VALUE *p_parse_value)
{
    ...
    if (simp_ble_service_send_v4_indicate(conn_handle, L2C_FIXED_CID_ATT, simp_srv_id,
                                          &ind_val, length))
    {
        return (RESULT_SUCESS);
    }
