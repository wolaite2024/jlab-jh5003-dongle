...
static const uint8_t hid_game_controller_sdp_record[] =
{
    //Total length
    SDP_DATA_ELEM_SEQ_HDR_2BYTE,
    0x01,
...
static const uint8_t ms_hs_hid_sdp_record[] =
{
    SDP_DATA_ELEM_SEQ_HDR,
    0x5C,
    //attribute SDP_ATTR_SRV_CLASS_ID_LIST
    ...
    SDP_STRING_HDR,
    0x0D,
    'T', 'E', 'A', 'M', 'S', ' ', 'C', 'O', 'N', 'T', 'R', 'O', 'L' //"TEAMS CONTROL"
};
...
void app_sdp_init(void)
{
...
#endif
#if F_APP_GAMING_CONTROLLER_SUPPORT && F_APP_BT_HID_CONTROLLER_SUPPORT
        bt_sdp_record_add((void *)hid_game_controller_sdp_record);
#endif
    ...
    bt_sdp_record_add((void *)ms_hs_hid_sdp_record);
