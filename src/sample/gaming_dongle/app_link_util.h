...
//#define SPP_AUDIO_PROFILE_MASK          0x00100000    /**< SPP Audio profile bitmask */
#define ASP_PROFILE_MASK                0x00100000    /**< MS Teams ASP profile bitmask */
#define GAIA_PROFILE_MASK               0x00200000    /**< MS GAIA profile bitmask */
#define MANUFACTURER_DATA_MASK          0x00400000    /**< MS Manufacturer data bitmask */
#define DEVICE_INFO_MASK                0x00800000    /**< PnP ID bitmask */
#define SPP_AUDIO_PROFILE_MASK          0x01000000    /**< SPP Audio profile bitmask */
...
/**
    * @brief  get connected br link addr
    * @param  bd_addr bluetooth address
    * @return the BR/EDR link
    */
