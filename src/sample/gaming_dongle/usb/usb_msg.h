...
typedef enum
{
    USB_OTHER_EVT_AUDIO_STOP,
    USB_OTHER_EVT_DELAY_USB_TX_START,
    USB_OTHER_EVT_AUDIO_USB_SRC_STREAM_STATE,
    USB_OTHER_EVT_AUDIO_USB_STREAM_READY_TO_TX,
    USB_OTHER_EVT_SILENCE_DETECT,
    USB_OTHER_EVT_FEEDBACK_SUPPORT,
} T_USB_OTHER_MODE_MSG;
...
#define IO_MSG_TYPE_USB IO_MSG_TYPE_USB_DEV
