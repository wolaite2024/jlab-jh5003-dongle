...
#define UAC2_ISO_OUT_ENDPOINT_ADDR      0x03
#define UAC2_ISO_IN_ENDPOINT_ADDR       0x84
#define ISO_OUT_FEEDBACK_ENDPOINT_ADDR  0x83
#else
#define UAC2_ISO_OUT_ENDPOINT_ADDR      UAC2_ISO_OUT_ENDPOINT_ADDRESS
#define UAC2_ISO_IN_ENDPOINT_ADDR       UAC2_ISO_IN_ENDPOINT_ADDRESS
#endif
#define UAC2_INTR_IN_ENDPOINT_ADDR      0x82
...
static const T_UAC2_OT_DESC uac2_ot_desc_spk =
{
    ...
    .wTerminalType          = UAC2_OUTPUT_TERMINAL_HEADPHONES,
    .bAssocTerminal         = 0x00,
...
static T_UAC2_STD_EP_DESC uac2_std_ep_desc_intr_hs =
{
    ...
    .bEndpointAddress       = UAC2_INTR_IN_ENDPOINT_ADDR,
...
static T_UAC2_STD_EP_DESC uac2_std_ep_desc_spk_hs =
{
    .bLength                = sizeof(T_UAC2_STD_EP_DESC),
    .bDescriptorType        = UAC2_DT_ENDPOINT,
    .bEndpointAddress       = UAC2_ISO_OUT_ENDPOINT_ADDR,
#if F_APP_USB_AUDIO_FEEDBACK_SUPPORT
    .bmAttributes           = UAC2_EP_XFER_ISOC | UAC2_EP_SYNC_ASYNC,
    .wMaxPacketSize         = 64 * (UAC2_SPK_BIT_RES / 8) * UAC2_SPK_CHAN_NUM,
#else
    .bmAttributes           = UAC2_EP_XFER_ISOC | UAC2_EP_SYNC_ADAPTIVE,
    .wMaxPacketSize         = (UAC2_SPK_SAM_RATE_MAX / 1000) * (UAC2_SPK_BIT_RES / 8) * UAC2_SPK_CHAN_NUM,
#endif
#if F_APP_USB_HIGH_SPEED_0_5MS
    .bInterval              = 3, // UAC2_DS_INTERVAL,
#else
    .bInterval              = 4, // UAC2_DS_INTERVAL,
#endif
};
...
#if F_APP_USB_AUDIO_FEEDBACK_SUPPORT
static T_UAC2_STD_EP_DESC uac2_iso_ep_desc_spk_feedback_hs =
{
    .bLength            = sizeof(T_UAC2_STD_EP_DESC),
    .bDescriptorType    = UAC2_DT_ENDPOINT,
    .bEndpointAddress   = ISO_OUT_FEEDBACK_ENDPOINT_ADDR,
    .bmAttributes       = UAC2_EP_XFER_ISOC | USB_EP_USAGE_FEEDBACK,
    .wMaxPacketSize     = 4,
    .bInterval          = 4,
};

static T_UAC2_STD_EP_DESC uac2_iso_ep_desc_spk_feedback_fs =
{
    .bLength            = sizeof(T_UAC2_STD_EP_DESC),
    .bDescriptorType    = UAC2_DT_ENDPOINT,
    .bEndpointAddress   = ISO_OUT_FEEDBACK_ENDPOINT_ADDR,
...
static T_UAC2_STD_EP_DESC uac2_std_ep_desc_mic_hs =
{
    .bLength                = sizeof(T_UAC2_STD_EP_DESC),
    .bDescriptorType        = UAC2_DT_ENDPOINT,
    .bEndpointAddress       = UAC2_ISO_IN_ENDPOINT_ADDR,
    .bmAttributes           = UAC2_EP_XFER_ISOC | UAC2_EP_SYNC_SYNC,
    .wMaxPacketSize         = (UAC2_MIC_SAM_RATE_MAX / 1000) * (UAC2_MIC_BIT_RES / 8) * UAC2_MIC_CHAN_NUM,
    .bInterval              = 4,
};
...
#if F_APP_USB_AUDIO_FEEDBACK_SUPPORT
    (T_USB_AUDIO_DRIVER_DESC_HDR *) &uac2_iso_ep_desc_spk_feedback_hs,
#endif
#endif
...
static const T_USB_AUDIO_DRIVER_DESC_HDR *uac2_descs_spk_fs[] =
{
    ...
    (T_USB_AUDIO_DRIVER_DESC_HDR *) &uac2_iso_ep_desc_spk,
#if F_APP_USB_AUDIO_FEEDBACK_SUPPORT
    (T_USB_AUDIO_DRIVER_DESC_HDR *) &uac2_iso_ep_desc_spk_feedback_fs,
#endif
#endif
...
static T_CTRL_ATTR_FREQ(spk, UAC2_SPK_SAM_RATE_NUM) freq_attr_spk =
{
    ...
    .range =
    {
        ...
        .ranges =
        {
            [0] = {.dMIN = UAC_SAM_RATE_48000, .dMAX = UAC_SAM_RATE_48000, .dRES = 0},
        },
    },
};
...
{
    USB_AUDIO2_PIPE_CALLBACK(usb_audio2_pipe->feedback_d, usb_audio2_pipe, buf, len);

    *(uint32_t *)buf = TO_FB_FORMAT_16_16(*(uint32_t *)buf);
    return 0;
}
#endif
...
#endif
#if UAC_MIC_SUPPORT
        freq_attr_mic.cur.dCUR = UAC_SAM_RATE_48000;
