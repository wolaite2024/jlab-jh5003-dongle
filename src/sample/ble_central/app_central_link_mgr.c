...
#define APP_SRVS_HDL_TABLE_FLASH_OFFSET 0xC00
...
uint32_t app_save_srvs_hdl_table(T_APP_SRVS_HDL_TABLE *p_info)
{
    ...
    return ftl_save_to_storage(p_info, APP_SRVS_HDL_TABLE_FLASH_OFFSET, sizeof(T_APP_SRVS_HDL_TABLE));
}
...
{
    uint32_t result;
    result = ftl_load_from_storage(p_info, APP_SRVS_HDL_TABLE_FLASH_OFFSET,
