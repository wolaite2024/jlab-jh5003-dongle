...
#ifndef _APP_PERIPHERAL_ADV__
#define _APP_PERIPHERAL_ADV__
...
/**
 * @brief app_peripheral_adv_init_conn_public
 *        advertising parameter initialization: use public address to advertise connectable undirected advertising.
 ...
 */
void app_peripheral_adv_init_conn_public(void);

/**
 * @brief app_peripheral_adv_init_conn_random
 *        advertising parameter initialization: use static random address to advertise connectable undirected advertising.
 *        Advertising data or scan response data shall not exceed 31 bytes.
 * adv_handle        Identify an advertising set, which is assigned by @ref ble_ext_adv_mgr_init_adv_params.
 * adv_event_prop    Type of advertising event.
 *                   Values for legacy advertising PDUs: @ref T_LE_EXT_ADV_LEGACY_ADV_PROPERTY.
 ...
 * filter_policy     Advertising filter policy: @ref T_GAP_ADV_FILTER_POLICY.
 */
void app_peripheral_adv_init_conn_random(void);
