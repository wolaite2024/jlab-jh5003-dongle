 ...
 *
 */
#define F_BT_ANCS_APP_FILTER   (F_APP_BLE_ANCS_CLIENT_SUPPORT & 1)
#define F_BT_ANCS_GET_APP_ATTR (F_APP_BLE_ANCS_CLIENT_SUPPORT & 0)
 ...
 *
 */
#define F_BT_ANCS_CLIENT_DEBUG (F_APP_BLE_ANCS_CLIENT_SUPPORT & 0)

/**
 * @brief Config AMS
 * 0-Not built in, 1-Open AMS client function
 */
