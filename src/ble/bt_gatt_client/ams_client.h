 ...
 * \code{.c}
    void ams_init(void)
    {
        ams_client = ams_client_init(ams_client_cb, link_num);
    }
 * \endcode
 */
...
/**
  ...
  * \endcode
  */
//bool ams_write_entity_attr(uint16_t conn_handle, T_AMS_ENTITY_ATTR entity_attr);
