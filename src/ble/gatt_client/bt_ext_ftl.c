...
int bt_ext_ftl_partition_init(const T_STORAGE_PARTITION_INFO *info)
{
...
int bt_ext_ftl_partition_write(const T_STORAGE_PARTITION_INFO *info, size_t offset,
                               size_t len,
                               void *buf)
{
#if (FTL_POOL_ENABLE == 1)
...
int bt_ext_ftl_partition_read(const T_STORAGE_PARTITION_INFO *info, size_t offset,
                              size_t len,
                              void *buf)
{
#if (FTL_POOL_ENABLE == 1)
