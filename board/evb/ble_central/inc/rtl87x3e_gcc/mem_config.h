...
#define APP_RAM_TEXT_SIZE           (15*1024 + 256)
#else
#define APP_RAM_TEXT_SIZE           (11*1024 + 256)
#endif
#if F_APP_BT_AUDIO_TRANSMITTER_DEMO_SUPPORT
#define APP_GLOBAL_BASE_SIZE       (12*1024 + 756)
#elif F_APP_CHARGE_CASE_DEMO_SUPPORT
#define APP_GLOBAL_BASE_SIZE       (17*1024 + 512)
#else
#define APP_GLOBAL_BASE_SIZE       (14*1024 + 512)
#endif
#if F_APP_FINDMY_FEATURE_SUPPORT
#define APP_FINDMY_SIZE            (8*1024)
#else
#define APP_FINDMY_SIZE            0
#endif
#define APP_GLOBAL_SIZE            (APP_GLOBAL_BASE_SIZE + APP_FINDMY_SIZE)
