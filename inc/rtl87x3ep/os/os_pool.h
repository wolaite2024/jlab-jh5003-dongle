...
bool os_pool_create_intern_rom(uint8_t *p_handle, RAM_TYPE ram_type, uint16_t buf_size,
                               uint16_t buf_count, const char *p_func, uint32_t file_line);
bool os_pool_extend_intern_rom(uint8_t handle, uint16_t buf_size, uint16_t buf_count,
                               const char *p_func, uint32_t file_line);
bool os_pool_delete_intern_rom(uint8_t handle, const char *p_func, uint32_t file_line);
void *os_buffer_get_intern_rom(uint8_t handle, uint16_t buf_size,
                               const char *p_func, uint32_t file_line);
