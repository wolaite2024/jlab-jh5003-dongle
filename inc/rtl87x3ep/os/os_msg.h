...
bool os_msg_queue_create_intern_rom(void **pp_handle, const char *p_name, uint32_t msg_num,
                                    uint32_t msg_size,
                                    const char *p_func, uint32_t file_line);
bool os_msg_queue_delete_intern_rom(void *p_handle, const char *p_func, uint32_t file_line);
bool os_msg_queue_peek_intern_rom(void *p_handle, uint32_t *p_msg_num,
                                  const char *p_func, uint32_t file_line);
bool os_msg_send_intern_rom(void *p_handle, void *p_msg, uint32_t wait_ms,
                            const char *p_func, uint32_t file_line);
bool os_msg_recv_intern_rom(void *p_handle, void *p_msg, uint32_t wait_ms,
                            const char *p_func, uint32_t file_line);
