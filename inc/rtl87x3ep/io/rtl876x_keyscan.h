...
/** @defgroup 87x3e_Keyscan_DebounceTime Keyscan DebounceTime
  * @{
  */

#define IS_KEYSCAN_MAX_SCAN_DATA(DATA_NUM) ((DATA_NUM) <= 26)    //0 means no limit

/** End of group 87x3e_Keyscan_DebounceTime
  * @}
  */
...
/** @defgroup 87x3e_Keyscanv_scan_interval_en Keyscan scan interval enable
  * @{
  */
...
/** End of group 87x3e_Keyscanv_scan_interval_en
  * @}
  */

/** @defgroup 87x3e_Keyscan_release_detect_timer_en Keyscan release detect timer en
  * @{
  */
