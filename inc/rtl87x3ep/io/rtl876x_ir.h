...
/** @defgroup 87x3e_IR_Rx_Start_Mode RX Start Mode
  * @{
  */
...
/** @defgroup 87x3e_IR_RX_Trigger_Mode RX Trigger Mode
  * @{
  */
...
/** @defgroup 87x3e_IR_RX_Filter_Time RX Filter Time
  * @{
  */
...
typedef enum
{
    ...
    IR_COMPEN_FLAG_0_8_CARRIER      = ((uint32_t)(0 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_1_8_CARRIER      = ((uint32_t)(1 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_1_4_CARRIER      = ((uint32_t)(2 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_2_8_CARRIER      = ((uint32_t)(2 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_3_8_CARRIER      = ((uint32_t)(3 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_1_2_CARRIER      = ((uint32_t)(4 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_4_8_CARRIER      = ((uint32_t)(4 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_5_8_CARRIER      = ((uint32_t)(5 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_6_8_CARRIER      = ((uint32_t)(6 << IR_LOW_PERIOD_COMPENSATION_Pos)),
    IR_COMPEN_FLAG_7_8_CARRIER      = ((uint32_t)(7 << IR_LOW_PERIOD_COMPENSATION_Pos)),
...
/**
  * @brief  Set space time compensation if need more accurate space time.
  *  \xrefitem Added_API_2_12_1_0 "Added Since 2.12.1.0" "Added API"
  * @param  comp_type:
  *     @arg IR_COMPEN_FLAG_0_8_CARRIER: no compensation.
  *     @arg IR_COMPEN_FLAG_1_8_CARRIER: 1/8 carrier cycle.
  *     @arg IR_COMPEN_FLAG_2_8_CARRIER: 2/8 carrier cycle.
  *     @arg IR_COMPEN_FLAG_3_8_CARRIER: 3/8 carrier cycle.
  *     @arg IR_COMPEN_FLAG_4_8_CARRIER: 4/8 carrier cycle.
  *     @arg IR_COMPEN_FLAG_5_8_CARRIER: 5/8 carrier cycle.
  *     @arg IR_COMPEN_FLAG_6_8_CARRIER: 6/8 carrier cycle.
  *     @arg IR_COMPEN_FLAG_7_8_CARRIER: 7/8 carrier cycle.
