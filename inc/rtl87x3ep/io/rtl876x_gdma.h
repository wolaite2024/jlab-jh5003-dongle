...
#define IS_GDMA_ChannelNum(NUM) ((NUM) < 12)
#define GDMA_TOTAL_CH_COUNT (12)
...
#define GDMA_Handshake_CAN_BUS_RX        (23)
...
#define GDMA_Handshake_RTZIP_RX          (43)
#define GDMA_Handshake_RTZIP_TX          (44)
#define GDMA_Handshake_SM3               (46)
#define GDMA_Handshake_SHA256            (47)
...
#define DMA_CH_IRQ(ChNum) ((IRQn_Type)((ChNum >= 9) ? (GDMA0_Channel9_IRQn + ChNum - 9) : (GDMA0_Channel0_IRQn + ChNum)))
#define DMA_CH_VECTOR(ChNum) ((VECTORn_Type)((ChNum >= 9) ? (GDMA0_Channel9_VECTORn + ChNum - 9) : (GDMA0_Channel0_VECTORn + ChNum)))
#define DMA_VECTOR_TO_CH_NUM(vector) (((vector) <= GDMA0_Channel8_VECTORn )? (vector) - GDMA0_Channel0_VECTORn:(vector) - GDMA0_Channel9_VECTORn + 9)
#define DMA_MAX_VECTORN             GDMA0_Channel11_VECTORn
