...
__weak void PPE_Handler(void);
__weak void IMDC_Handler(void);
__weak void Slave_Port_Monitor_Handler(void);
__weak void RTK_Timer0_Handler(void);
__weak void RTK_Timer1_Handler(void);
__weak void RTK_Timer2_Handler(void);
__weak void RTK_Timer3_Handler(void);
__weak void CAN_Handler(void);
__weak void BTMAC_WRAP_AROUND_Handler(void);
__weak void SHA256_Handler(void);
__weak void Public_Key_Engine_Handler(void);
__weak void SPI_PHY1_INTR_Handler(void);
