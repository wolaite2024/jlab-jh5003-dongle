...
typedef enum t_bt_event
{
    ...
    /**
     * \brief Indicate local OOB data response event \ref T_BT_EVENT_PARAM_LOCAL_OOB_DATA_RSP.
     */
    BT_EVENT_LOCAL_OOB_DATA_RSP                       = 0x000c,

    /**
     * \brief Indicate local OOB extended data response event \ref T_BT_EVENT_PARAM_LOCAL_OOB_EXTENDED_DATA_RSP.
     */
    ...
    */
    ...
    /**
     * \brief Indicate HFP select codec type \ref T_BT_EVENT_PARAM_HFP_CODEC_TYPE_SELECTED.
     */
     ...
     */
    BT_EVENT_HFP_AG_CODEC_TYPE_SELECTED               = 0x34a8,
    ...
    */
    ...
    /**
    * \brief Indicate HFP AG placing a call to the phone number stored in memory \ref T_BT_EVENT_PARAM_HFP_AG_DIAL_WITH_MEMORY.
    */
    BT_EVENT_HFP_AG_DIAL_WITH_MEMORY                  = 0x34b0,

    /**
    * \brief Indicate HFP AG memory dialing \ref T_BT_EVENT_PARAM_HFP_AG_DIAL_LAST_NUMBER.
    */
    BT_EVENT_HFP_AG_DIAL_LAST_NUMBER                  = 0x34b1,
    ...
    */
    BT_EVENT_HFP_AG_3WAY_HELD_CALL_RELEASED           = 0x34b2,
    ...
    */
    BT_EVENT_HFP_AG_3WAY_ACTIVE_CALL_RELEASED         = 0x34b3,
    ...
    */
    BT_EVENT_HFP_AG_3WAY_SWITCHED                     = 0x34b4,

    /**
    * \brief Indicate HFP AG adds a held call to the conversation \ref T_BT_EVENT_PARAM_HFP_AG_3WAY_MERGED.
    */
    BT_EVENT_HFP_AG_3WAY_MERGED                       = 0x34b5,

    /**
    * \brief Indicate HFP AG retrieve subscriber number information \ref T_BT_EVENT_PARAM_HFP_AG_SUBSCRIBER_NUMBER_QUERY.
    */
    BT_EVENT_HFP_AG_SUBSCRIBER_NUMBER_QUERY           = 0x34b6,

    /**
    * \brief Indicate HFP AG set name format to long alphanumeric \ref T_BT_EVENT_PARAM_HFP_AG_NETWORK_NAME_FORMAT_SET.
    */
    BT_EVENT_HFP_AG_NETWORK_NAME_FORMAT_SET           = 0x34b7,

    /**
    * \brief Indicate HFP AG query the currently selected operator \ref T_BT_EVENT_PARAM_HFP_AG_CURR_OPERATOR_QUERY.
    */
    BT_EVENT_HFP_AG_CURR_OPERATOR_QUERY               = 0x34b8,

    /**
    * \brief Indicate HFP AG enhanced safety status \ref T_BT_EVENT_PARAM_HFP_AG_ENHANCED_SAFETY_STATUS.
    */
    BT_EVENT_HFP_AG_ENHANCED_SAFETY_STATUS            = 0x34b9,

    /**
    * \brief Indicate HFP AG noise reduction and echo canceling status \ref T_BT_EVENT_PARAM_HFP_AG_NREC_STATUS.
    */
    BT_EVENT_HFP_AG_NREC_STATUS                       = 0x34ba,

    /**
     * \brief Indicate HFP AG voice recognition activation \ref T_BT_EVENT_PARAM_HFP_AG_VOICE_RECOGNITION_ACTIVATION.
     */
    BT_EVENT_HFP_AG_VOICE_RECOGNITION_ACTIVATION      = 0x34bb,

    /**
     * \brief Indicate HFP AG voice recognition deactivation \ref T_BT_EVENT_PARAM_HFP_AG_VOICE_RECOGNITION_DEACTIVATION.
     */
    ...
    */
    ...
    /**
     * \brief Indicate HID Host control connection indication \ref T_BT_EVENT_PARAM_HID_HOST_CONN_IND.
     */
    BT_EVENT_HID_HOST_CONN_IND                        = 0x3680,

    /**
     * \brief Indicate HID Host control connection complete \ref T_BT_EVENT_PARAM_HID_HOST_CONN_CMPL.
     */
    BT_EVENT_HID_HOST_CONN_CMPL                       = 0x3681,

    /**
     * \brief Indicate HID Host control connection fail \ref T_BT_EVENT_PARAM_HID_HOST_CONN_FAIL.
     */
    BT_EVENT_HID_HOST_CONN_FAIL                       = 0x3682,

    /**
     * \brief Indicate HID Host control disconnection complete \ref T_BT_EVENT_PARAM_HID_HOST_DISCONN_CMPL.
     */
    ...
    /**
     * \brief Indicate HID Host get report response \ref T_BT_EVENT_PARAM_HID_HOST_GET_REPORT_RSP.
     */
    BT_EVENT_HID_HOST_GET_REPORT_RSP                  = 0x3685,

    /**
     * \brief Indicate HID Host set report response \ref T_BT_EVENT_PARAM_HID_HOST_SET_REPORT_RSP.
     */
    BT_EVENT_HID_HOST_SET_REPORT_RSP                  = 0x3686,

    /**
     * \brief Indicate HID Host get protocol response \ref T_BT_EVENT_PARAM_HID_HOST_GET_PROTOCOL_RSP.
     */
    BT_EVENT_HID_HOST_GET_PROTOCOL_RSP                = 0x3687,

    /**
     * \brief Indicate HID Host set protocol response \ref T_BT_EVENT_PARAM_HID_HOST_SET_PROTOCOL_RSP.
     */
    BT_EVENT_HID_HOST_SET_PROTOCOL_RSP                = 0x3688,

    /**
     * \brief Indicate HID Host sniffing connection complete \ref T_BT_EVENT_PARAM_HID_HOST_SNIFFING_CONN_CMPL.
     */
    BT_EVENT_HID_HOST_SNIFFING_CONN_CMPL              = 0x3689,

    /**
     * \brief Indicate HID Host sniffing disconnection complete \ref T_BT_EVENT_PARAM_HID_HOST_SNIFFING_DISCONN_CMPL.
     */
    BT_EVENT_HID_HOST_SNIFFING_DISCONN_CMPL           = 0x368a,

    /**
     * \brief Indicate HID Host interrupt data indication \ref T_BT_EVENT_PARAM_HID_HOST_INTERRUPT_DATA_IND.
     */
    BT_EVENT_HID_HOST_INTERRUPT_DATA_IND              = 0x368b,
    ...
    /**
     * \brief Indicate OPP connection indication \ref T_BT_EVENT_PARAM_OPP_CONN_IND.
     */
    BT_EVENT_OPP_CONN_IND                             = 0x3800,

    /**
     * \brief Indicate OPP connection complete \ref T_BT_EVENT_PARAM_OPP_CONN_CMPL.
     */
    BT_EVENT_OPP_CONN_CMPL                            = 0x3801,

    /**
     * \brief Indicate OPP connection fail \ref T_BT_EVENT_PARAM_OPP_CONN_FAIL.
     */
    BT_EVENT_OPP_CONN_FAIL                            = 0x3802,

    /**
     * \brief Indicate OPP disconnection complete \ref T_BT_EVENT_PARAM_OPP_DISCONN_CMPL.
     */
    BT_EVENT_OPP_DISCONN_CMPL                         = 0x3803,

    /**
     * \brief Indicate OPP data header indication \ref T_BT_EVENT_PARAM_OPP_DATA_HEADER_IND.
     */
    BT_EVENT_OPP_DATA_HEADER_IND                      = 0x3804,

    /**
     * \brief Indicate OPP data indication \ref T_BT_EVENT_PARAM_OPP_DATA_IND.
     */
    BT_EVENT_OPP_DATA_IND                             = 0x3805,

    /**
     * \brief Indicate OPP put data response \ref T_BT_EVENT_PARAM_OPP_DATA_RSP.
     */
    BT_EVENT_OPP_DATA_RSP                             = 0x3806,
...
typedef enum t_bt_roleswap_status
{
    ...
    BT_ROLESWAP_STATUS_HID_DEVICE_INFO  = 0x08,
    BT_ROLESWAP_STATUS_HID_HOST_INFO    = 0x09,
 ...
 * \ingroup BT_BTM
 */
typedef enum t_bt_hfp_codec_type
{
    BT_CODEC_TYPE_NONE = 0x00,
    BT_CODEC_TYPE_CVSD = 0x01,
    BT_CODEC_TYPE_MSBC = 0x02,
    BT_CODEC_TYPE_LC3  = 0x03,
} T_BT_HFP_CODEC_TYPE;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_local_oob_data_rsp
{
    uint16_t cause;
    uint8_t  data_c[16];
    uint8_t  data_r[16];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_local_oob_extended_data_rsp
{
    uint16_t cause;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_absolute_volume_set_rsp
{
    uint8_t bd_addr[6];
    uint8_t state;
    uint8_t volume;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_addressed_player_set
{
    uint8_t  bd_addr[6];
    uint16_t player_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_reg_addressed_player_changed
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_folder_items_get
{
    uint8_t     bd_addr[6];
    uint8_t     scope_id;
    uint32_t    start_item;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_total_num_of_items_get
{
    uint8_t bd_addr[6];
    uint8_t scope_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_reg_track_changed
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_elem_attrs_get
{
    uint8_t  bd_addr[6];
    uint8_t  attr_num;
    uint32_t attr_id[8];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_play_status_get
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_power
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_avrcp_mute
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_vendor_cmd_result
{
    uint8_t                bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_codec_type_selected
{
    uint8_t             bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_ag_dial_with_memory
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_ag_nrec_status
{
    uint8_t bd_addr[6];
    uint8_t status;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_ag_voice_recognition_activation
{
    uint8_t  bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hfp_ag_voice_recognition_deactivation
{
    uint8_t  bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_conn_ind
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_conn_cmpl
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_conn_fail
{
    uint8_t  bd_addr[6];
    uint16_t cause;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_disconn_cmpl
{
    uint8_t  bd_addr[6];
    uint16_t cause;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_control_data_ind
{
    uint8_t    bd_addr[6];
    uint8_t    report_type;
    uint8_t    report_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_get_report_ind
{
    uint8_t    bd_addr[6];
    uint8_t    report_type;
    uint8_t    report_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_set_report_ind
{
    uint8_t    bd_addr[6];
    uint8_t    report_type;
    uint8_t    report_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_get_protocol_ind
{
    uint8_t    bd_addr[6];
    uint8_t    proto_mode;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_set_protocol_ind
{
    uint8_t    bd_addr[6];
    uint8_t    proto_mode;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_set_idle_ind
{
    uint8_t    bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_interrupt_data_ind
{
    uint8_t    bd_addr[6];
    uint8_t    report_type;
    uint8_t    report_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_sniffing_conn_cmpl
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_device_sniffing_disconn_cmpl
{
    uint8_t  bd_addr[6];
    uint16_t cause;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_conn_ind
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_conn_cmpl
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_conn_fail
{
    uint8_t  bd_addr[6];
    uint16_t cause;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_disconn_cmpl
{
    uint8_t  bd_addr[6];
    uint16_t cause;
    bool     virtual_unplug;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_hid_control_ind
{
    uint8_t    bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_get_report_rsp
{
    uint8_t    bd_addr[6];
    uint8_t    report_type;
    uint8_t    report_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_set_report_rsp
{
    uint8_t    bd_addr[6];
    uint8_t    result_code;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_get_protocol_rsp
{
    uint8_t    bd_addr[6];
    uint8_t    proto_mode;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_set_protocol_rsp
{
    uint8_t    bd_addr[6];
    uint8_t    result_code;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_interrupt_data_ind
{
    uint8_t    bd_addr[6];
    uint8_t    report_type;
    uint8_t    report_id;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_sniffing_conn_cmpl
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_hid_host_sniffing_disconn_cmpl
{
    uint8_t  bd_addr[6];
    uint16_t cause;
    bool     virtual_unplug;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_opp_conn_ind
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_opp_conn_cmpl
{
    uint8_t bd_addr[6];
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_opp_conn_fail
{
    uint8_t  bd_addr[6];
    uint16_t cause;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_opp_disconn_cmpl
{
    uint8_t  bd_addr[6];
    uint16_t cause;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_opp_data_ind
{
    uint8_t     bd_addr[6];
    uint16_t    data_len;
    bool        data_end;
 ...
 * \ingroup BT_BTM
 */
typedef struct t_bt_event_param_opp_data_rsp
{
    uint8_t     bd_addr[6];
    uint8_t     cause;
...
{
    uint8_t                 bd_addr[6];        /**< Bluetooth address of remote device. */
    bool                    just_works;        /**< Just Works association model. */
 ...
 * \ingroup  BT_BTM
 */
typedef void (*P_BT_MGR_CBACK)(T_BT_EVENT  event_type,
                               void       *event_buf,
                               uint16_t    buf_len);
 ...
 * \param[in] max_latency      A value in milliseconds representing upper limit of the sum of the
 ...
 * \retval true     SCO connection request was sent successfully.
 * \retval false    SCO connection request was failed to send.
 *
 * \ingroup BT_BTM
 */
 ...
 * \param[in] tx_bandwidth         Transmit bandwidth in octets per second.
 * \param[in] rx_bandwidth         Receive bandwidth in octets per second.
 * \param[in] max_latency          A value in milliseconds representing upper limit of the sum of
 *                                 the synchronous interval. Valid values are 0x0004 to 0xFFFE.
 * \param[in] voice_setting        Voice setting bitmap.
 * \param[in] retrans_effort       Retransmit effort.
 ...
 * \param[in] bd_addr          Remote BT address.
 *
 * \return The status of sending SCO disconnection request.
 * \retval true     SCO disconnection request was sent successfully.
 * \retval false    SCO disconnection request was failed to send.
 *
 * \ingroup BT_BTM
 */
 ...
 * \param[in] buf        SCO data buffer to send.
 * \param[in] len        SCO data buffer length.
 *
 * \return The status of sending SCO data.
 * \retval true     SCO data was sent successfully.
 * \retval false    SCO data was failed to send.
 *
 * \ingroup BT_BTM
 */
 ...
 *
 * \param[in] bd_addr            Bluetooth device address.
 * \param[in] basic_data_rate    Data rate in basic rate mode, defined in \ref T_BT_LINK_DATA_RATE,
 *                               only 1M data rate is valid.
 * \param[in] enhanced_data_rate Data rate in enhanced data rate mode, defined in \ref T_BT_LINK_DATA_RATE,
 *                               2M and 3M data rate are valid.
 *
 * \return The status of set preferred data rate.
 * \retval true     Preferred data rate was set successfully.
 * \retval false    Preferred data rate was failed to set.
 *
 * \ingroup BT_BTM
 */
 ...
 * \param[in] tpoll      The poll interval ranged from 0x06 to 0x1000 in 625us slot units.
 *
 ...
 * \param[in] bd_addr    Bluetooth device address.
 *
 * \return The status of enabling BT role switch.
 * \retval true     BT role switch was enabled successfully.
 * \retval false    BT role switch was failed to enable.
 *
 * \ingroup BT_BTM
 */
 ...
 * \param[in] bd_addr    Bluetooth device address.
 *
 * \return The status of disabling BT role switch.
 * \retval true     BT role switch was disabled successfully.
 * \retval false    BT role switch was failed to disable.
 *
 * \ingroup BT_BTM
 */
