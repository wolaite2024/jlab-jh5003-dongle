...
typedef enum t_bt_avp_event
{
    ...
    BT_AVP_EVENT_VOLUME_CONTROL_SETTINGS           = 0x11,
...
typedef struct
{
    uint8_t bd_addr[6];
    bool    is_enable;
} T_BT_AVP_EVENT_VOLUME_CONTROL_SETTINGS;
...
typedef union t_bt_avp_event_param
{
    ...
    T_BT_AVP_EVENT_VOLUME_CONTROL_SETTINGS          volume_control_settings;
...
bool bt_avp_bud_location_report(uint8_t               bd_addr[6],
                                T_BT_AVP_BUD_LOCATION pri_ear_location,
                                T_BT_AVP_BUD_LOCATION sec_ear_location,
                                bool                  is_right);

bool bt_avp_couple_battery_level_report(uint8_t bd_addr[6],
                                        uint8_t right_ear_level,
                                        uint8_t right_ear_charging,
                                        uint8_t left_ear_level,
                                        uint8_t left_ear_charging,
                                        uint8_t case_level,
                                        uint8_t case_status);

bool bt_avp_single_battery_level_report(uint8_t bd_addr[6],
                                        uint8_t level,
                                        uint8_t charging);

bool bt_avp_anc_setting_report(uint8_t      bd_addr[6],
                               T_BT_AVP_ANC anc_setting);

bool bt_avp_compactness_test_report(uint8_t bd_addr[6],
                                    bool    right_ear_result,
