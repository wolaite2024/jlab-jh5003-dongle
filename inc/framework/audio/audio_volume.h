...
/**
 * \brief Define the Audio Volume channel masks.
 *
 ...
 *
 * \param[in] mask  The Audio Volume out channel mask \ref T_AUDIO_VOLUME_CHANNEL_MASK.
 *
 * \return          The status of setting the global volume out channel mask.
 * \retval  true    The global Audio Volume out channel mask was set successfully.
 * \retval  false   The global Audio Volume out channel mask was failed to set.
 *
 * \ingroup AUDIO_VOLUME
 */
 ...
 *
 * \param[in] mask  The Audio Volume in channel mask \ref T_AUDIO_VOLUME_CHANNEL_MASK.
 *
 * \return          The status of setting the global volume in channel mask.
 * \retval  true    The global Audio Volume in channel mask was set successfully.
 * \retval  false   The global Audio Volume in channel mask was failed to set.
 *
 * \ingroup AUDIO_VOLUME
 */
