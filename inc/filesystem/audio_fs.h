...
*****************************************************************************************
   ...
   * *************************************************************************************
  */
/** @defgroup  AUDIO_FS   Audio Fs
  * @brief audio fs module
  * @{
  */
...
/**
 * @brief           get total space and free space
 * \xrefitem Experimental_Added_API_2_13_0_0 "Experimental Added Since 2.13.0.0" "Experimental Added API"
 * @param ptotalSpace       pointer to the total space
 * @param pfreeSpace        pointer to the free space
 * @return          true if get successful, otherwise false
 */
