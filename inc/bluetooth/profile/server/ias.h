...
*****************************************************************************************
  * @file     ias.h
  * @brief    Header file for using immediate alert service.
...
/** @defgroup IAS Immediate Alert Service
  ...
  * @details
    ...
    Immediate Alert Service contains an Alert Level characteristic, to which any value other than "No Alert" being written will trigger an alarm in the device.
    ...
    Applications shall register Immediate Alert Service during initialization through @ref ias_add_service function.
...
/**
  * @brief Add immediate alert service to the Bluetooth Host.
  *
