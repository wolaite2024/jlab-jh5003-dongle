...
*****************************************************************************************
  * @file     bas.h
  * @brief    Header file for using battery service.
 ...
 *
 * Call this function with a battery service parameter type and it will set the
 ...
 *                      "p_value" field must point to data with type of "uint16_t".
 *
 ...
 * @param[in]   p_value Pointer to data to write. This is dependent on
                        ...
                        If param_type is set to @ref BAS_PARAM_BATTERY_LEVEL, p_value points to the current
