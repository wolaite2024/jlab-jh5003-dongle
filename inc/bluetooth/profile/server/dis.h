...
*****************************************************************************************
  * @file     dis.h
  * @brief    Header file for using device information service.
 ...
 *
 * This function can be called with a device information service parameter type and it will set the
 ...
 *                      "p_value" field must point to data with the type "uint16_t".
 *
