...
/**
 * @brief LNS Control Point data, variable length during connection, max can reach 17 bytes.
 *
 ...
 *
 * This function can be called with a Location and Navigation service parameter type and it will set the
