 ...
 *         If this API is called successfully, the Application will receive
 *         LE_AUDIO_MSG_VCS_CLIENT_CP_RESULT.
 *         The parameter op can't set to VCS_CP_SET_ABSOLUTE_VOLUME, VCS_CP_UNMUTE and VCS_CP_MUTE.
 *         Application can call cap_vcs_change_mute and cap_vcs_change_volume instead.
 *
 * \xrefitem Experimental_Added_API_2_13_0_0 "Experimental Added Since 2.13.0.0" "Experimental Added API"
 *
