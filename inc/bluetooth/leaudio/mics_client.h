 ...
 *
 * The message data for @ref LE_AUDIO_MSG_MICS_CLIENT_DIS_DONE.
 *
 ...
 *
 * The message data for @ref LE_AUDIO_MSG_MICS_CLIENT_WRITE_RESULT.
 *
 * \ingroup MICP_Client_Exported_Types
 */
typedef struct
 ...
 *
 * The message data for @ref LE_AUDIO_MSG_MICS_CLIENT_NOTIFY.
 *
 * \ingroup MICP_Client_Exported_Types
 */
typedef struct
 ...
 * \param[in]  p_aics_instance  Pointer to AICS service attribute instance:
 *                              @ref T_ATTR_INSTANCE.
 *
 ...
 * mics_client.h
 *
 * \brief  MICS client writes mute value.
 *
 * \param[in]  conn_handle      Connection handle.
 * \param[in]  mic_mute         MICS mute value: @ref T_MICS_MUTE.
 *
 * \return         The result of MICS client writing mute value.
 * \retval true    MICS client writing mute value is successful.
 * \retval false   MICS client writing mute value failed.
 *
 * \ingroup MICP_Client_Exported_Functions
 */
 ...
 *
 * \return         The result of getting MICS mute value.
 * \retval true    Getting MICS mute value is successful.
 * \retval false   Getting MICS mute value failed.
 *
 * \ingroup MICP_Client_Exported_Functions
 */
