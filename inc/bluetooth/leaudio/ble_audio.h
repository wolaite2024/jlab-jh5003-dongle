...
/**
 * \defgroup    LEA_LIB_Exported_Macros LE Audio Lib Exported Macros
 *
 * \ingroup LEA_LIB
 * @{
 */
 ...
 * ble_audio.h
 *
 * \defgroup BLE_AUDIO_CB_RESULT LE Audio Callback Result
 *
 * \brief  Define LE audio callback result.
 *
 ...
 * ble_audio.h
 *
 * \brief  LE audio message group types.
 *
...
typedef enum
{
    ...
    LE_AUDIO_MSG_GROUP_GMAS         = 0x1A00,
    LE_AUDIO_MSG_GROUP_GMAS_CLIENT  = 0x1B00,
 ...
 * ble_audio.h
 *
 * \brief  LE audio message types.
 *
 * Each service and client has a different LE audio message group @ref T_LE_AUDIO_MSG_GROUP.
 *
 * \ingroup LEA_LIB_Exported_Types
 */
typedef enum
{
    ...
    LE_AUDIO_MSG_ASCS_CIS_CONN_INFO                   = LE_AUDIO_MSG_GROUP_ASCS | 0x0c,
    LE_AUDIO_MSG_ASCS_CP_RELEASE_IND                  = LE_AUDIO_MSG_GROUP_ASCS | 0x0d,
    ...
    /* gmas_mgr.h */
    LE_AUDIO_MSG_GMAS_READ_IND                        = LE_AUDIO_MSG_GROUP_GMAS | 0x00,
    /* gmas_client.h */
    LE_AUDIO_MSG_GMAS_CLIENT_DIS_DONE                 = LE_AUDIO_MSG_GROUP_GMAS_CLIENT | 0x00,
    LE_AUDIO_MSG_GMAS_CLIENT_READ_ROLE_RESULT         = LE_AUDIO_MSG_GROUP_GMAS_CLIENT | 0x01,
    LE_AUDIO_MSG_GMAS_CLIENT_READ_FEATURE_RESULT      = LE_AUDIO_MSG_GROUP_GMAS_CLIENT | 0x02,
    ...
    LE_AUDIO_MSG_SERVER_ATTR_CCCD_INFO                = LE_AUDIO_MSG_GROUP_SERVER | 0x00,  /**< MCS_UUID_CHAR_MEDIA_PLAYER_NAME,
                                                                                                ...
                                                                                                VCS_UUID_CHAR_VOLUME_STATE,
                                                                                                VCS_UUID_CHAR_VOLUME_FLAGS,
                                                                                                MICS_UUID_CHAR_MUTE. */
 ...
 * ble_audio.h
 *
 * \brief  LE audio message error cause types.
 *
 * \ingroup LEA_LIB_Exported_Types
 */
typedef enum
 ...
 * ble_audio.h
 *
 * \brief  P_FUN_BLE_AUDIO_CB LE Audio Callback Function Point Definition.
 *
 * Function pointer used in LE audio module, to send events @ref T_LE_AUDIO_MSG to application.
 *
 * \ingroup LEA_LIB_Exported_Types
 */
 ...
 * ble_audio.h
 *
 * \brief  LE audio Volume Control and Microphone Control parameters.
 *
 * \ingroup LEA_LIB_Exported_Types
 */
typedef struct
{
    ...
    bool    vcs_enable;           /**< Whether to register VCS.
                                       \arg true: register.
                                       \arg false: Not register. */
    bool    mics_enable;          /**< Whether to register MICS.
                                       \arg true: register.
                                       \arg false: Not register. */
 ...
 * ble_audio.h
 *
 * \brief  LE bond modify state types.
 *
 * \ingroup LEA_LIB_Exported_Types
 */
typedef enum
 ...
 *
 * The message data for @ref LE_AUDIO_MSG_SERVER_ATTR_CCCD_INFO.
 *
 * \ingroup LEA_LIB_Exported_Types
 */
typedef struct
 ...
 *
 * The message data for @ref LE_AUDIO_MSG_CLIENT_ATTR_CCCD_INFO.
...
typedef struct
{
    ...
    uint16_t                char_uuid;
    uint16_t                cccd_cfg;  /**< CCCD value @ref GATT_CLT_CONFIG. */
    uint16_t                cause;
 ...
 *
 * \param[in]  p_param      Pointer to LE audio initial parameters:
 *                          @ref T_BLE_AUDIO_PARAMS.
 *
 * \return         The result of initializing LE audio.
 * \retval true    Initializing LE audio is successful.
 * \retval false   Initializing LE audio failed.
 *
 ...
 * ble_audio.h
 *
 * \brief  Register LE audio callback.
 *
 ...
 * \return         The result of registering LE audio callback.
 * \retval true    Registering LE audio callback is successful.
 * \retval false   Registering LE audio callback failed.
 *
 * \ingroup LEA_LIB_Exported_Functions
 */
 ...
 * ble_audio.h
 *
 * \brief  Unregister LE audio callback.
 *
 * \xrefitem Experimental_Added_API_2_13_0_0 "Experimental Added Since 2.13.0.0" "Experimental Added API"
 *
 * \param[in] cback Callback function: @ref P_FUN_BLE_AUDIO_CB.
 * \return         The result of unregistering LE audio callback.
 * \retval true    Unregistering LE audio callback is successful.
 * \retval false   Unregistering LE audio callback failed.
 *
 * \ingroup LEA_LIB_Exported_Functions
 */
 ...
 *
 * \param[in]  p_param      Pointer to LE Audio Volume Control and Microphone
 ...
 * \retval true    Initializing LE Audio Volume Control and Microphone Control is successful.
 * \retval false   Initializing LE Audio Volume Control and Microphone Control failed.
 *
 * \ingroup LEA_LIB_Exported_Functions
 */
 ...
 * \retval false   LE audio remote features do not match.
 *
 * \ingroup LEA_LIB_Exported_Functions
 */
