...
typedef struct
{
    ...
    bool             sync_transfer_received_flag;/**< If successfully synchronized to the periodic
                                                      advertising train,
                                                      @arg False: Synchronization is established by
                                                             @ref le_pa_sync_create_sync.
                                                      @arg True:  Synchronization is received by
 ...
 *                           If param is @ref PA_SYNC_PARAM_PERIODIC_ADV_LIST_SIZE or @ref PA_SYNC_PARAM_DEV_STATE,
 ...
 *
 * @note This function to add, remove or clear Periodic Advertiser list can be called after Bluetooth Host is ready. \n
