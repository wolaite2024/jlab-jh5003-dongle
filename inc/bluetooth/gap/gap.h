...
#define GAP_MSG_SET_LOCAL_BD_ADDR       0x02 //!<gap_set_bd_addr
#define GAP_MSG_VENDOR_CMD_CMPL_EVENT   0x03 //!<Vendor command complete event for mp test
#define GAP_MSG_DUMP_TX_GAIN_IDX        0x04
...
#define GAP_MSG_VENDOR_CMD_RSP  0x16 //!<gap_vendor_cmd_req
...
/** @brief Reponse for set local public address */
typedef struct
{
...
/**
 * @brief   Set public address of local device, the result will be notified by callback regisgtered
            by @ref gap_register_app_cb.
 * @return Operation result.
 * @retval GAP_CAUSE_SUCCESS Operation success.
 * @retval Others Operation failure.
 ...
 * <b>Example usage</b>
 * \code{.c}
    static T_USER_CMD_PARSE_RESULT cmd_setaddr(T_USER_CMD_PARSED_VALUE *p_parse_value)
    {
        uint8_t bd_addr[6] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55};
        T_GAP_CAUSE cause;
        cause = gap_set_bd_addr(bd_addr);
        return (T_USER_CMD_PARSE_RESULT)cause;
    }
