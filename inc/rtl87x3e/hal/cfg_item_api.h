...
/**
  ...
  * @return the result of writing low power frequency offset config data to system config, fail or success.
  * @retval true              Success.
  * @retval false             Fail.
  */
...
/**
  ...
  * @return the result of reading low power frequency offset config data, fail or success.
  * @retval true              Success.
  * @retval false             Fail.
  */
