...
uint32_t os_lock_rom(void);
void os_unlock_rom(uint32_t s);
bool os_sem_create_rom(void **pp_handle, const char *p_name, uint32_t init_count,
                       uint32_t max_count);
bool os_sem_delete_rom(void *p_handle);
bool os_sem_take_rom(void *p_handle, uint32_t wait_ms);
bool os_sem_give_rom(void *p_handle);
bool os_mutex_create_rom(void **pp_handle);
bool os_mutex_delete_rom(void *p_handle);
