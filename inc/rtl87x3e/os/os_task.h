...
bool os_task_create_rom(void **pp_handle, const char *p_name, void (*p_routine)(void *),
                        void *p_param, uint16_t stack_size, uint16_t priority);
bool os_task_delete_rom(void *p_handle);
bool os_task_suspend_rom(void *p_handle);
bool os_task_resume_rom(void *p_handle);
bool os_task_yield_rom(void);
bool os_task_handle_get_rom(void **pp_handle);
bool os_task_priority_get_rom(void *p_handle, uint16_t *p_priority);
bool os_task_priority_set_rom(void *p_handle, uint16_t priority);
bool os_task_signal_send_rom(void *p_handle, uint32_t signal);
bool os_task_signal_recv_rom(uint32_t *p_signal, uint32_t wait_ms);
