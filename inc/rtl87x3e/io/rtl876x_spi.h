...
typedef struct
{
    ...
    uint32_t SPI_SwapTxBitEn;              /*!< Specifies whether to swap spi tx data bit. Only SPI0 supports bit swap. */

    uint32_t SPI_SwapRxBitEn;              /*!< Specifies whether to swap spi rx data bit. Only SPI0 supports bit swap. */

    uint32_t SPI_SwapTxByteEn;              /*!< Specifies whether to swap spi tx data bit. Only SPI0 supports byte swap. */

    uint32_t SPI_SwapRxByteEn;              /*!< Specifies whether to swap spi rx data bit. Only SPI0 supports byte swap. */
    ...
    uint32_t SPI_BaudRatePrescaler;        /*!< Specifies the speed of SCK clock.
                                                SPI Clock Speed = clk source(fixed 40Mhz)/SPI_ClkDIV/SPI_BaudRatePrescaler,
                                                clk source is 40Mhz by default,
                                                SPI_ClkDIV refer API RCC_SPIClkDivConfig
                                                SPI_BaudRatePrescaler: should be any even value between 2 and 65534
...
/**
  * @brief  Set spi prescaler, Fsclk_out = Fssi_clk/prescaler use this api to get spi sclk. before use this api spi should be disable first.
 ...
 *
 * \param[in] SPI_DataSize: parameter of data size, please refer to "SPI Data Size" part.
 *
 * \return  None.
 *
 * <b>Example usage</b>
 ...
 *
 * \param[in] NewState: Specifies whether to swap spi tx data byte.
  *           This parameter can be: ENABLE or DISABLE.
 * \return  None.
 *
 * <b>Example usage</b>
...
/**
  ...
  *         brefore call this function please make sure the SPIx been initialized.
  * @param  SPIx: where x can be 0 or 1 2
