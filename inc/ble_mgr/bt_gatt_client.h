 ...
 *        The event data for GATT_STORAGE_EVENT_SVC_TBL_USING_DATABASE_HASH_GET_IND.
 *        After application calls gatt_client_start_discovery_all, bt gatt client may send
 *        GATT_STORAGE_EVENT_SVC_TBL_USING_DATABASE_HASH_GET_IND to check whether application has saved the service table.
 ...
 *        The event data for GATT_CLIENT_EVENT_READ_RESULT or GATT_CLIENT_EVENT_READ_UUID_RESULT.
 */
typedef struct
{
...
*@param[in] length       Length of data to be written.
                         ...
                         GATT_WRITE_TYPE_SIGNED_CMD is not supported.
...
*@param[in] p_char_uuid   Pointer to characteristic UUID @ref T_ATTR_UUID.
*                         The instance_id need to be the actual value of service instance_id.
*@param[in,out] p_handle  Pointer to characteristic attribute value handle.
*@return   bool
...
*@param[in] p_char_uuid   Pointer to characteristic UUID @ref T_ATTR_UUID.
*                         The instance_id need to be the actual value of characteristic instance_id.
*@param[in,out] p_handle  Pointer to characteristic cccd attribute handle.
*@return   bool
...
*@return   bool.
*@retval   true   Get service characteristic properties success.
