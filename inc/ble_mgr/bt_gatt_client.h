...
/** @defgroup BT_GATT_CLT Bluetooth GATT Client
  * @brief Bluetooth GATT Client
  * @{
  */
 ...
 *                              Macros
 *============================================================================*/
/** @defgroup BT_GATT_CLIENT_Exported_Macros Bluetooth GATT Client Exported Macros
  * @{
  */

/** @defgroup GATT_CLT_DISCOV_MODE  GATT Client Discover Mode Bit Field
 *  @brief Used for gatt_client_init.
  * @{
  */
#define GATT_CLIENT_DISCOV_MODE_CLOSED           0       /**< Not use Bluetooth GATT client module. */
#define GATT_CLIENT_DISCOV_MODE_REG_SVC_BIT      0x01    /**< Only discover the services registered by @ref gatt_client_spec_register. */
#define GATT_CLIENT_DISCOV_MODE_ALL_SVC_BIT      0x02    /**< Discover all the services. */
#define GATT_CLIENT_DISCOV_MODE_CCCD_STORAGE_BIT 0x04    /**< Storage CCCD, send @ref GATT_STORAGE_EVENT_SVC_CCCD_GET_IND
                                                              and @ref GATT_STORAGE_EVENT_SVC_CCCD_SET_IND to application. */
#define GATT_CLIENT_DISCOV_MODE_USE_EXT_CLIENT   0x10    /**< Use the interfaces provided by profile_client_ext.h. */
#define GATT_CLIENT_DISCOV_MODE_GATT_SVC         0x20    /**< Open GATT service, send @ref GATT_CLIENT_EVENT_GATT_SERVICE_INFO to 
                                                              callback registered by @ref gatt_client_start_discovery_all.*/
/**
  * @}
  */
...
/** @defgroup GATT_SVC_DEF  GATT Service Definitions
  * @{
  */
...
/** @defgroup GATT_SVC_CLT_SUP_FEATURE  GATT Service Client Supported Features Bit Field
  * @{
  */
...
/** @defgroup GATT_SVC_SRV_SUP_FEATURE  GATT Service Server Supported Features Bit Field
  * @{
  */
...
/** End of BT_GATT_CLIENT_Exported_Macros
 * @}
 */
 ...
 *                              Types
 *============================================================================*/
/** @defgroup BT_GATT_CLIENT_Exported_Types Bluetooth GATT Client Exported Types
  * @{
  */
...
typedef enum
{
    ...
    GATT_STORAGE_EVENT_SVC_TBL_USING_DATABASE_HASH_GET_IND  = 0x07,
...
typedef struct
{
    uint8_t  char_exist; /**< Characteristic exist bit field.  @ref GATT_SVC_CHAR. */
    uint8_t  data_exist; /**< Data exist bit field.  @ref GATT_SVC_CHAR. */
    uint8_t  database_hash[GATT_SVC_DATABASE_HASH_LEN]; /**< The value can be used when the bit of @ref GATT_SVC_DATABASE_HASH_FLAG in data_exist is set. */
    uint8_t  client_supported_features_len; /**< The value can be used when the bit of @ref GATT_SVC_CLIENT_SUPPORTED_FEATURES_FLAG in data_exist is set. */
    uint8_t  client_supported_features[GATT_SVC_CLIENT_SUPPORTED_FEATURES_MAX_LEN]; /**< The value can be used when the bit of @ref GATT_SVC_CLIENT_SUPPORTED_FEATURES_FLAG in data_exist is set. */
    uint8_t  server_supported_features_len; /**< The value can be used when the bit of @ref GATT_SVC_SERVER_SUPPORTED_FEATURES_FLAG in data_exist is set. */
    uint8_t  server_supported_features[GATT_SVC_SERVER_SUPPORTED_FEATURES_MAX_LEN]; /**< The value can be used when the bit of @ref GATT_SVC_SERVER_SUPPORTED_FEATURES_FLAG in data_exist is set. */
} T_GATT_SERVICE_DATA;

/**
 * @brief Get stored services table indication data.
 *
 * The event data for @ref GATT_STORAGE_EVENT_SVC_TBL_GET_IND.
 * After application calls @ref gatt_client_start_discovery_all, Bluetooth GATT client will send
 * @ref GATT_STORAGE_EVENT_SVC_TBL_GET_IND first to check whether application has saved the service table.
 */
typedef struct
{
    uint8_t  addr[6];
...
/**
 * @brief Get stored services table using database hash value indication data.
 *
 * The event data for @ref GATT_STORAGE_EVENT_SVC_TBL_USING_DATABASE_HASH_GET_IND.
 * After application calls @ref gatt_client_start_discovery_all, Bluetooth GATT client may send
 * @ref GATT_STORAGE_EVENT_SVC_TBL_USING_DATABASE_HASH_GET_IND to check whether application has saved the service table.
 *
 * This event is used for Robust Caching,
 * application can call gatt_client_cfg_client_supported_feature(GATT_SVC_CLIENT_SUPPORTED_FEATURES_ROBUST_CACHING_BIT) to open this function.
 */
typedef struct
{
    uint8_t  addr[6];
    uint8_t  remote_bd_type;
    uint8_t  database_hash[GATT_SVC_DATABASE_HASH_LEN];
    uint16_t data_len;        /**< Provided by application. */
    uint8_t  *p_data;         /**< Provided by application. */
} T_GATT_STORAGE_SVC_TBL_USING_DATABASE_HASH_GET_IND;

/**
 * @brief Set stored services table indication data.
 *
 * The event data for @ref GATT_STORAGE_EVENT_SVC_TBL_SET_IND.
 * If the services are actually discovered after the
 * @ref gatt_client_start_discovery_all is called, notify the application
...
typedef struct
{
    ...
    uint16_t  data_len;       /**< Provided by Bluetooth GATT Client module. */
    uint8_t  *p_data;         /**< Provided by Bluetooth GATT Client module. */
} T_GATT_STORAGE_SVC_TBL_SET_IND;

/**
 * @brief Get stored services CCCD data.
 *
 * The event data for @ref GATT_STORAGE_EVENT_SVC_CCCD_GET_IND.
 */
typedef struct
{
    uint8_t  addr[6];
 ...
 *
 * The event data for @ref GATT_STORAGE_EVENT_SVC_CCCD_SET_IND.
 */
typedef struct
{
    uint8_t   addr[6];
 ...
 *
 * The event data for @ref GATT_STORAGE_EVENT_SVC_GATT_GET_IND.
 */
typedef struct
{
    uint8_t  addr[6];
 ...
 *
 * The event data for @ref GATT_STORAGE_EVENT_SVC_GATT_SET_IND.
 */
typedef struct
{
    uint8_t   addr[6];
...
typedef enum
{
    ...
    GATT_CLIENT_EVENT_READ_UUID_RESULT = 0x08,

    GATT_CLIENT_EVENT_DIS_ALL_STATE = 0x30,     /**< General client callback event: Discovery done event. */
    GATT_CLIENT_EVENT_GATT_SERVICE_INFO = 0x31, /**< General client callback event: GATT service information. */
    GATT_CLIENT_EVENT_SERVICE_CHANGED_INDICATION = 0x32, /**< General client callback event: Service changed indication. */
} T_GATT_CLIENT_EVENT;
 ...
 *
 * The event data for @ref GATT_CLIENT_EVENT_DIS_ALL_STATE.
 */
typedef struct
{
 ...
 *
 * The event data for @ref GATT_CLIENT_EVENT_GATT_SERVICE_INFO.
 */
typedef struct
{
    bool is_found;
...
/**
 * @brief Service changed indication.
 *
 * The event data for @ref GATT_CLIENT_EVENT_SERVICE_CHANGED_INDICATION.
 */
typedef struct
{
    uint16_t start_handle;
    uint16_t end_handle;
} T_GATT_CLIENT_SERVICE_CHANGED_INDICATION;

/**
 * @brief Client discover service result.
 *
 * The event data for @ref GATT_CLIENT_EVENT_DIS_DONE.
 */
typedef struct
{
    bool is_found;
 ...
 *
 * The event data for @ref GATT_CLIENT_EVENT_READ_RESULT or @ref GATT_CLIENT_EVENT_READ_UUID_RESULT.
 */
typedef struct
{
 ...
 *
 * The event data for @ref GATT_CLIENT_EVENT_WRITE_RESULT.
 */
typedef struct
{
    T_GATT_CHAR_TYPE char_type;
 ...
 *
 * The event data for @ref GATT_CLIENT_EVENT_NOTIFY_IND.
 */
typedef struct
{
    uint8_t srv_instance_id;
 ...
 *
 * The event data for @ref GATT_CLIENT_EVENT_CCCD_CFG.
 */
typedef struct
{
    bool srv_cfg;
 ...
 *
 * The event data for @ref GATT_CLIENT_EVENT_CONN_DEL.
 */
typedef struct
{
    bool transport_le;
 ...
 * The events please refer to @ref T_GATT_CLIENT_EVENT.
 */
 ...
 *                              Functions
 *============================================================================*/
/** @defgroup BT_GATT_CLIENT_Exported_Functions Bluetooth GATT Client Exported Functions
  * @{
  */
 ...
 * \arg    Others  Send general client callback event to application, such as @ref GATT_CLIENT_EVENT_DIS_ALL_STATE.
 * @return   Operation result.   @ref T_GAP_CAUSE.
 * @retval   GAP_CAUSE_SUCCESS   Discovery request success.
 * @retval   Others              Discovery request failed.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * @param[in] p_srv_uuid   Pointer to service UUID @ref T_ATTR_UUID.
                           The instance_id needs to be the actual value of service instance_id.
 * @param[in] cccd_cfg     CCCD value @ref GATT_CLT_CONFIG.
 * @return   Operation result.   @ref T_GAP_CAUSE.
 * @retval   GAP_CAUSE_SUCCESS   Enable CCCD request success.
 * @retval   Others              Enable CCCD request failed.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 *                         The instance_id can be set to 0 if the cccd_cfg set to GATT_CLIENT_CONFIG_ALL.
 * @param[in] cccd_cfg     CCCD value @ref GATT_CLT_CONFIG.
 * @return   Operation result.   @ref T_GAP_CAUSE.
 * @retval   GAP_CAUSE_SUCCESS   Enable CCCD request success.
 * @retval   Others              Enable CCCD request failed.
 ...
 * \arg    Others  Check the specific characteristic CCCD.
...
/**
 * @brief    Read characteristic value or characteristic descriptors by handle.
 * @param[in] conn_handle  Connection handle of the ACL link.
 * @param[in] handle       Request handle.
 * @param[in] p_req_cb     Specific client read request callback function.
 * \arg    NULL    Send @ref GATT_CLIENT_EVENT_READ_RESULT through the callback function
                   registered by gatt_client_spec_register.
 * \arg    Others  Send @ref GATT_CLIENT_EVENT_READ_RESULT through the callback function p_req_cb.
 * @return   Operation result.   @ref T_GAP_CAUSE.
 * @retval   GAP_CAUSE_SUCCESS   Read request success.
 * @retval   Others              Read request failed.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
 * @brief    Write characteristic value or characteristic descriptors by handle.
 * @param[in] conn_handle  Connection handle of the ACL link.
 ...
 * @param[in] length       Length of data to be written.
                           ...
                           @ref GATT_WRITE_TYPE_SIGNED_CMD is not supported.
 ...
 * \arg    NULL    Send @ref GATT_CLIENT_EVENT_WRITE_RESULT through the callback function
                   registered by gatt_client_spec_register.
 * \arg    Others  Send @ref GATT_CLIENT_EVENT_WRITE_RESULT through the callback function p_req_cb.
 * @return   Operation result.   @ref T_GAP_CAUSE.
 * @retval   GAP_CAUSE_SUCCESS   Write request success.
 * @retval   Others              Write request failed.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * @brief  Confirm from application when receive indication from server.
           if APP wants to send confirmation itself and the return cause of GATT_CLIENT_EVENT_NOTIFY_IND is APP_RESULT_PENDING.
 * \xrefitem Added_API_2_13_0_0 "Added Since 2.13.0.0" "Added API"
 * @param[in]  conn_handle    Connection handle of the ACL link.
 * @param[in]  cid            Local CID. The value shall be get from @ref GATT_CLIENT_EVENT_NOTIFY_IND callback.
 * @return   Operation result.   @ref T_GAP_CAUSE.
 * @retval   GAP_CAUSE_SUCCESS   Confirm success.
 * @retval   Others              Confirm failed.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * @retval   Others              Register callback request failed.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * @param[in,out] p_cccd_handle   Pointer to CCCD handle. When CCCD handle is zero,
                                  this characteristic does not contain the Client Characteristic Configuration descriptor.
 * @return   Operation result.
...
bool gatt_client_find_char_descriptor_range(uint16_t conn_handle, T_ATTR_UUID *p_srv_uuid,
                                            T_ATTR_UUID *p_char_uuid,
                                            uint16_t *p_start_handle, uint16_t *p_end_handle, uint16_t *p_cccd_handle);

/**
 * @brief    Find characteristic value handle.
 * @param[in] conn_handle   Connection handle of the ACL link.
 * @param[in] p_srv_uuid    Pointer to service UUID @ref T_ATTR_UUID.
 *                          The instance_id needs to be the actual value of the service instance_id.
 * @param[in] p_char_uuid   Pointer to characteristic UUID @ref T_ATTR_UUID.
 *                          The instance_id needs to be the actual value of the service instance_id.
 * @param[in,out] p_handle  Pointer to the characteristic attribute value handle.
 * @return   Operation result.
 * @retval   true   Find characteristic value handle success.
 * @retval   false  Find characteristic value handle failed.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 *                          The instance_id needs to be the actual value of the service instance_id.
 * @param[in] p_char_uuid   Pointer to characteristic UUID @ref T_ATTR_UUID.
 *                          The instance_id needs to be the actual value of the characteristic instance_id.
 * @param[in,out] p_handle  Pointer to the characteristic CCCD attribute handle.
 * @param[in,out] p_cccd_prop  Pointer to the characteristic CCCD property.
 * @return   Operation result.
 * @retval   true   Find characteristic CCCD attribute handle success.
 * @retval   false  Find characteristic CCCD attribute handle failed.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * @param[in,out] p_attr_instance  Pointer to the service attribute instance @ref T_ATTR_INSTANCE.
 * @return   Operation result.
 ...
 * @param[in] p_char_uuid  Pointer to characteristic UUID @ref T_ATTR_UUID.
 *                         The instance_id can be set to 0.
 * @return   The number of service characteristics.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
 * @brief    Get service characteristic properties.
 * @param[in] conn_handle       Connection handle of the ACL link.
 * @param[in] p_srv_uuid        Pointer to service UUID @ref T_ATTR_UUID.
 *                              The instance_id needs to be the actual value of service instance_id.
 * @param[in] p_char_uuid       Pointer to characteristic UUID @ref T_ATTR_UUID.
 *                              The instance_id needs to be the actual value of characteristic instance_id.
 * @param[in,out] p_properties  Pointer to characteristic properties @ref GATT_ATTRIBUTE.
 * @return   Operation result.
 * @retval   true   Get service characteristic properties successfully.
 * @retval   false  Get service characteristic properties failed.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/**
 * @brief    Whether to get the service table from FTL.
 * \xrefitem Added_API_2_12_0_0 "Added Since 2.12.0.0" "Added API"
 * @param[in] conn_handle  Connection handle of the ACL link.
 * @return   Operation result.
 * @retval   true   Get the service table from FTL.
 * @retval   false  Do not get the service table from FTL.
 *
 * <b>Example usage</b>
 * \code{.c}
 ...
 * \xrefitem Added_API_2_12_0_0 "Added Since 2.12.0.0" "Added API"
 * @param[in] mode  Discover mode @ref GATT_CLT_DISCOV_MODE.
 * @return   Operation result.
 * @retval   true   Initialize GATT client success.
 * @retval   false  Initialize GATT client failed.
 * @note     Application can't use functions @ref client_init and @ref client_cfg_use_ext_api
 *          when use function @ref gatt_client_init to initialize the GATT client module.
 *
 * <b>Example usage</b>
 * \code{.c}
...
/** End of BT_GATT_CLIENT_Exported_Functions
  * @}
  */
/** End of BT_GATT_CLT
  * @}
